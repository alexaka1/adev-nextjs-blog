...
summary: "Or why having a brain aneurysm is not worth it just because Microsoft says so"
...
> ### Enhance your Blazor experience with great toolingLeverage rich tooling for Blazor in Visual Studio Code and Visual Studio to get started fast using built-in project templates and scaffolding, hot reload, and AI-powered code editing.
